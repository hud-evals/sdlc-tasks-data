...
def force_version_check() -> VersionInfo | None:
    """Force a version check, bypassing the cache and CI/testing guards.

    This is useful for explicit version checks, release verification,
    and testing — including in CI environments where check_for_updates()
